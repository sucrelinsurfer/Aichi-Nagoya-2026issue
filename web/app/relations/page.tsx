...
const UNITS: Unit[] = [
  ...
  },
  {
    ...
    dispute:
      "被質疑遴選是否公開透明。但「協會沒交培訓計畫」可排除：協會確有「2026名古屋亞運選手培訓參賽實施計畫」（公布於協會官網、依國訓中心來函修正、2025/1/9 選訓會議通過），並循母法第二類的「專案」評估路徑爭取——即協會有提報、有努力。真正落差是：這份計畫未出現在運動部／國訓中心的亞運官方清單（其他亞奧項目都有），根源仍在衝浪被列非亞奧（見運動部一欄）。",
