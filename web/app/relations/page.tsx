...
const UNITS: Unit[] = [
  ...
  },
  {
    ...
    dispute: [
      ...
      "這場決定不派男子的 6/26 審查會，至今沒有公開會議紀錄與評估依據。",
    ],
  },
  {
    tone: "ctsa",
    ...
    dispute: [
      "會議記錄上可見協會確有交「2026名古屋亞運選手培訓參賽實施計畫」（協會官網、依國訓中心來函修正、2025/1/9 選訓會議通過），並走「專案」制度：因選手難達母法亞運參賽標準第②項「亞錦賽前4名」，改循第④項「經評估並專案核定」的專案路徑。真正落差是：這份計畫未出現在運動部／國訓中心的亞運官方清單（其他亞奧項目都有），根源仍在衝浪被列非亞奧（見運動部一欄）。",
      "相較於 2025/1/9 選訓會議留有完整記錄，決定不派男子的 6/26 審查會，至今沒有公開會議紀錄。",
      "選手質疑協會未事先、公開說明遴選與審查的規定和程序：當事選手鍾昀蓉公開發文指出，選手依協會規劃跑完三場選拔，最後只等到「等待運動部審核」，卻始終沒被完整告知為何要審、依據為何；直到送審期限前才臨時被通知備妥實力評估等資料，資訊還多由家長輾轉得知。她強調「期待的並非保證參賽，而是資訊公開、程序透明」。",
    ],
  },
  {
    tone: "athlete",
    ...
    dispute: [
      "質疑協會未充分告知：「拿到亞運門票 ≠ 就能出賽」，名額仍須通過主管機關（運動部／國訓中心）的資格標準審查——這一關選手事前並不清楚。",
      "質疑協會準備不足：相關程序多在緊急情況下補件，未及備妥選手競技實力等資料，送國訓中心、運動部備查。",
      "實力對照（外界可檢視）：四人 2024、2025 兩屆亞錦賽多有 ASF 成績（公開組／U18），唯尤佳琦缺 2024 紀錄；完整成績見時間軸。",
    ],
  },
  {
    tone: "ctoc",
      ...
      <div className="mx-auto max-w-3xl space-y-14 px-6 py-16">
        ...
        <section className="rounded-2xl border border-amber/30 bg-amber/5 p-6">
          ...
          <ul className="mt-3 space-y-2 text-[13px] leading-relaxed text-slate-600">
            ...
            <li>
              3. <span className="font-bold">協會確有交培訓計畫，但不在官方亞運清單</span>
              ：協會官網有「2026名古屋亞運選手培訓參賽實施計畫」、且依國訓中心來函修正、2025/1/9 通過——**「協會沒送」已排除**。但其他亞奧項目的計畫都列在{" "}
              <a
              ...
              也只有年度文件）。剩下的問題是「為何不在官方清單」：最可能因列非亞奧、不在此提報／公布體系；或最終輔導小組核定狀態未明。
            </li>
            <li>
        ...
        {/* 後續追蹤：本站正在做的事（有別於「尚待釐清」＝還沒查清的） */}
        <section className="rounded-2xl border border-wave/30 bg-foam/40 p-6">
          <h2 className="text-lg font-black text-ink">後續追蹤（本站持續進行）</h2>
          <ul className="mt-3 space-y-2 text-[13px] leading-relaxed text-slate-600">
            <li>
              · <span className="font-bold">問「為何仍列非亞奧」</span>
              ：衝浪 2021 就納入亞運、2020 已是奧運項目，本站將向運動部正式詢問為何至今仍列非亞奧。有回覆即更新於此。
            </li>
            <li>
              · <span className="font-bold">可行的透明途徑</span>
              ：依《政府資訊公開法》，任何人（含當事選手／家長）可向運動部、國訓中心申請調閱 6/26 審議會議紀錄與「不予提名」的依據。標準攤開，爭議才有解——這也是本站主張的第一步。
            </li>
          </ul>
          <p className="mt-3 border-t border-wave/20 pt-2 text-xs text-slate-400">
            這一區記錄「本站正在追的事」，與上方「尚待釐清」相對；有進展就更新。
          </p>
        </section>
