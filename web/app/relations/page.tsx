...
const UNITS: Unit[] = [
  ...
  },
  {
    ...
    dispute:
      "被質疑遴選是否公開透明。但「協會沒交培訓計畫」可排除：協會確有「2026名古屋亞運選手培訓參賽實施計畫」（協會官網、依國訓中心來函修正、2025/1/9 選訓會議通過）。因選手難達母法亞運參賽標準第②項「亞錦賽前4名」，協會改走第④項「經評估並專案核定」的專案路徑——即協會有努力。真正落差是：這份計畫未出現在運動部／國訓中心的亞運官方清單（其他亞奧項目都有），根源仍在衝浪被列非亞奧（見運動部一欄）。",
    disputeFlag: "協會有交・已釐清",
  },
  {
    tone: "athlete",
    name: "選手（與家長）",
