...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    id: "tl-quota",
    date: "2024/3/29",
    title: "資格制度公布：規則訂定，台灣屬可分配區域",
    body: "衝浪的亞運名額不是「個人打進亞錦賽前四就換一張票」，而是團體積分換算的國家配額。ASF《參賽資格制度》訂定：男 24／女 24、每國上限 2 男 2 女，配額由 2024、2025 兩屆亞錦賽依「區域代表（Regional Representation）」與國家團體排名分配——區域劃分依 OCA 規章，中華台北屬 East Asia 區。此版文件僅載規則，並未明列台灣已取得幾席；並訂明配額結果由 ASF 於「2026 年 6 月前」公布並通知各國奧會。",
    fact: {
      status: "verified",
      note: "已核對 ASF《參賽資格制度》PDF（版本 2024/3/29）：男24／女24、每國上限2男2女；配額由 2024、2025 兩屆亞錦賽依「區域代表」分配（Section E：區域劃分依 OCA 章程附件 II，中華台北屬 East Asia）。Section F 明載配額結果「on or before June 2026」由 ASF 公布並通知各 NOC。故本文件確立「規則＋台灣所屬可分配區域」，但**未明列席次數**——「拿下 4 席」是後續（2025 賽後）才定案，見下方 2025/8 與 2026/3/9 兩則。",
      sources: [
        {
  ...
  },
  {
    id: "tl-results",
    date: "2024–2025",
    title: "兩屆亞錦賽個人名次（點開看四人全成績）",
    body: "公開組個人名次：女子 2024 陳宛榆（Wan-Yu Chen）第 13、鍾昀蓉（Yun-Jung Chung）並列第 9；2025 陳宛榆並列第 7、鍾昀蓉並列第 13。男子 2025 詹博宇（John John Chan）並列第 17、尤佳琦（Chia-Chi Yu）並列第 25。四人公開組名次皆未達常態「前 4 名」門檻——這也是後來遴選爭議的起點。另四人多在 U18 青少年組亦有成績，完整對照見下表；唯尤佳琦缺 2024 年紀錄。",
    table: {
      columns: ["選手", "2024 公開組", "2024 U18", "2025 公開組", "2025 U18"],
      groups: [
        {
          label: "男子組",
          rows: [
        ...
        },
        {
          label: "女子組",
          rows: [
            ["陳宛榆 Wan-Yu Chen", "13", "並列 9", "並列 7", "並列 5"],
            ["鍾昀蓉 Yun-Jung Chung", "並列 9", "—", "並列 13", "—"],
          ],
        },
      ],
    },
    fact: {
      status: "verified",
      note: "公開組名次見 ASF 2024 亞錦賽國家排行與 2025 LiveHeats 官方賽果；男子 2025 詹博宇並列 17、尤佳琦並列 25。U18 青少年組成績另附 ASF 2024 U18 排行截圖（詹博宇 2024 U18 並列 7；陳宛榆 2024 U18 並列 9、2025 U18 並列 5；尤佳琦 2025 U18 並列 5）。尤佳琦 2024 年於公開組與 U18 皆無 ASF 紀錄。",
      sources: [
        {
  ...
  },
  {
    id: "tl-quota-2024",
    date: "2024/8",
    title: "2024 亞錦賽後：公開男女組積分先取得一男一女",
    body: "2024 年亞錦賽打完，台灣以公開男子組、公開女子組的團體積分，在男、女各先取得 1 個亞運可分配席位（一男一女）。選手端 IG 貼文「獲得門票」已可佐證取得資格。配額採 2024＋2025 兩屆累計、2026/6 由 ASF 正式公布——此為第一階段，隔年再累加成男2女2（見下方 2025/8）。",
    fact: {
      status: "verified",
      note: "配額由 2024、2025 兩屆亞錦賽團體積分累計而定；2024 賽後公開男女組積分讓台灣先取得一男一女。選手端 2024/8 IG 貼文「獲得門票」畫面已明確佐證取得資格，已截圖存證。",
      sources: [
        {
          title: "選手 IG 貼文「獲得門票」（2024/8，公開男女組積分取得一男一女）",
          url: "https://www.instagram.com/p/C_NmKjivIAD/",
        },
      ],
    },
  },
  {
    id: "tl-ctsa-plan",
    date: "2025/1/9",
    title: "協會通過亞運培訓計畫，走「專案」路徑爭取",
    side: "association",
    body: "衝浪協會第4屆第18次選訓會議通過修正後的「2026年第20屆名古屋亞洲運動會選手培訓參賽實施計畫」與遴選辦法，會議記錄載明「依國訓中心來函辦理修正」。母法附件2 亞運參賽標準列四條路，衝浪選手難達第②項「亞錦賽前4名」，協會改循第④項「經評估並專案核定」（即專案路徑）爭取——即協會確有提報。",
    fact: {
      status: "verified",
      note: "會議記錄（第4屆第18次選訓會議，114/1/9）白紙黑字：案由為修正「2026名古屋亞運選手培訓參賽實施計畫」與遴選辦法、說明「依國訓中心來函辦理修正」、議決「通過」。可證協會有寫此計畫、與國訓中心有往來、走專案路徑。母法附件2「亞運」參賽標準四條路：①最近一屆奧運前8名 ②亞運/亞錦賽等前4名 ③特定項目世界排名前100 ④延續奧運培訓必要或經評估並專案核定；衝浪達不到①②③，走的是第④條專案核定（另見《母法拆解_培訓與參賽標準.md》）。",
      sources: [
        {
          title: "協會第4屆第18次選訓會議記錄（2025/1/9，含截圖存證）",
          url: "https://www.ctsasurf.org/_files/ugd/737dc7_e4a6c075b1d843949eb0969e82173d00.pdf",
        },
        {
          title: "培訓參賽實施計畫 PDF（母法，附件2 亞運第二類標準）",
          url: "/docs/training-plan-11109.pdf",
        },
      ],
    },
  },
  {
    id: "tl-quota-got",
    date: "2025/8",
    title: "2025 亞錦賽後，再取得一男一女，累計共4席",
    body: "2025 亞錦賽（6 月）打完後，公開男女組積分再取得一男一女；與 2024 年的一男一女累加，兩屆合計男 2、女 2 共 4 席。選手端約在此時即已知取得資格——這與後來官方「2026/3 才通知」的時序有落差。",
    fact: {
      status: "partial",
      note: "配額由 2024、2025 兩屆亞錦賽排名累加而定，2025 賽後結果即定。「2025/8 選手端已知情」有一則 2025/8 IG 貼文為佐證（畫面中選手手持標示「2026」之物，已截圖存證），惟貼文未明言「拿到門票」，故確切時點列為待查。",
      sources: [
        {
          title: "選手 IG 貼文（2025/8，畫面手持標示2026之物）",
          url: "https://www.instagram.com/p/DNjyzCIT1Qy/",
        },
      ],
    },
  },
  {
    id: "tl-quota-notified",
    date: "2026/3/9",
    title: "協會收到中華奧會通知：取得 4 席暫定配額",
    body: "中華民國衝浪協會於本日收到中華奧會正式通知，確認取得男 2、女 2 共 4 席暫定配額。（ASF 端的正式配額公布則在 2026 年 6 月。）",
    fact: {
      status: "partial",
      note: "「3/9 收到通知」出自協會對外說法，無獨立第三方佐證，列為部分屬實。ASF 官方《暫定配額分配表》於 2026/6 公布。對照上則 2025/8，可見「實際知情」與「官方通知」之間存在時間差。",
      sources: [
        {
          title: "ASF：名古屋亞運暫定配額分配表（2026/6）",
          url: "https://asiansurfing.org/2026/06/quota-places/",
        },
      ],
    },
  ...
  {
    date: "2026/6 底",
    title: "自費爭議：外界質疑為何不能自費",
    side: "athlete",
    body: "面對名額作廢，外界出現「既然達標、為何不能自費前往」的聲音，把爭議理解為經費問題；最知名的「費用我出」出自財經作家陳重銘（第三方），非選手或家長主動提出。選手家長則於此前後向總統府陳情，盼保住席次。",
    fact: {
      status: "partial",
