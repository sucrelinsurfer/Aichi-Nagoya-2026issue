...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    ...
    side: "association",
    body: "衝浪協會第4屆第18次選訓會議通過修正後的「2026年第20屆名古屋亞洲運動會選手培訓參賽實施計畫」與遴選辦法，會議記錄載明「依國訓中心來函辦理修正」。因選手難達母法第二類「亞錦賽前4名」書面門檻，協會循第二類內建的「經評估並專案核定」彈性路徑爭取——即協會確有提報、也有努力。",
    fact: {
      status: "verified",
      note: "會議記錄（第4屆第18次選訓會議，114/1/9）白紙黑字：案由為修正「2026名古屋亞運選手培訓參賽實施計畫」與遴選辦法、說明「依國訓中心來函辦理修正」、議決「通過」。可證：協會有寫此計畫、且與國訓中心有往來、走專案路徑。母法附件2 亞運第二類參賽標準即為「亞錦賽前4名 或 經評估並專案核定」。註：計畫全文中的「第四類」分類尚待以計畫書 PDF 逐字核對。",
      sources: [
        {
