...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    id: "tl-quota-2024",
    date: "2024/8",
    title: "2024 亞錦賽後：公開男女組積分先卡進男1女1",
    body: "2024 年亞錦賽打完，台灣以公開男子組、公開女子組的團體積分，在男、女各先取得 1 個亞運可分配席位。選手端此時已有取得資格的跡象（IG 貼文）。配額採 2024＋2025 兩屆累計、2026/6 由 ASF 正式公布——此為第一階段，隔年再累加成男2女2（見下方 2025/8）。",
    fact: {
      status: "partial",
      note: "配額由 2024、2025 兩屆亞錦賽團體積分累計而定；2024 賽後公開男女組積分讓台灣在男、女各先取得 1 席的分配位置。選手端 2024/8 IG 貼文為佐證，惟貼文未逐字載明席次，確切時點列為部分屬實。",
      sources: [
        {
          title: "選手 IG 貼文（2024/8，公開男女組積分取得男1女1）",
  ...
  },
  {
    id: "tl-quota-got",
    date: "2025/8",
    title: "2025 亞錦賽後，實際取得男2女2共4席",
    body: "2025 亞錦賽（6 月）打完、兩屆國家團體排名確定後，台灣實際取得男 2、女 2 共 4 席。選手端約在此時即已知取得資格——這與後來官方「2026/3 才通知」的時序有落差。",
    fact: {
      status: "partial",
