...
export const TIMELINE: TimelineItem[] = [
  ...
  },
  {
    ...
    side: "association",
    body: "衝浪協會第4屆第18次選訓會議通過修正後的「2026年第20屆名古屋亞洲運動會選手培訓參賽實施計畫」與遴選辦法，會議記錄載明「依國訓中心來函辦理修正」。母法附件2 亞運參賽標準列四條路，衝浪選手難達第②項「亞錦賽前4名」，協會改循第④項「經評估並專案核定」（即專案路徑）爭取——即協會確有提報、也有努力。",
    fact: {
      status: "verified",
